  ...
  return (
    <div className="cookieCard p-3 m-2">
      ...
      <p className="cookieDescription">
        Job description <a href="#">What for?</a>
      </p>
      <button className="acceptButton">Find out</button>
    </div>
  );
};
...
const App: React.FC = function MyApp() {
  ...
  return (
    <div>
      <main className="container-fluid" style={{ height: '100vh', overflow: 'hidden' }}>
        <div className="header mb-4">
          <div className="d-flex align-items-center">
            <Image src="/LOGO1.png" alt="Exponential PH Logo" width={75} height={75} />
        ...
        <div className="row" style={{ height: 'calc(100vh - 90px)' }}>
          <div className="col-md-4 border-end border-danger">
            <div className="d-flex flex-column">
              <CheckboxGroup title="Employment Type" options={employmentOptions} />
              <CheckboxGroup title="Experience Level" options={experienceOptions} />
              <CheckboxGroup title="Salary/Payment Range" options={salaryOptions} />
            </div>
          </div>

          <div className="col-md-8">
            <div className="overflow-auto" style={{ maxHeight: 'calc(100vh - 90px)' }}>
