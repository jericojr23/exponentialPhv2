...
const CompanyDetails = ({ company, companyTasks }) => {
  console.log({ company, companyTasks });
  const tasksGroupedByCategories = groupArrayOfObjects(
    companyJobs,
    'taskCategory'
  );
  console.log('tasksGroupedByCategories = ', tasksGroupedByCategories);
  return (
    <>
      <main>
        {/* Profile background */}
        ...
        <div className='px-4 sm:px-6 lg:px-8 py-8 w-full'>
          <div className='max-w-3xl mx-auto'>
            ...
            <div className='space-y-6'>
              {tasksGroupedByCategories &&
                Object.keys(tasksGroupedByCategories).map((taskCategory) => {
                  const tasks = tasksGroupedByCategories[taskCategory];
                  return (
                    <div key={taskCategory}>
